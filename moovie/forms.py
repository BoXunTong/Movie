...
class ReviewForm(forms.ModelForm):
    header = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': "Please enter a header."}),
        max_length=Review.HEADER_MAX_LENGTH, help_text="Header")
    comment = forms.CharField(
        widget=forms.Textarea(attrs={'class': 'form-control md-textarea', 'placeholder': "Please write your comment."}),
